...
class EntityFactory {
  ...
  */
  ...
  /**
  *
  * @brief Resets the count of all the entities in the arena to 0.
  *
  */
  void Reset();
  ...
  */
  ...
  /**
  * @brief An attempt to construct randomly sized lights.
  */
  double SetRadiusRandomlyLight();
  /**
  * @brief An attempt to construct randomly sized robots within the range 8-14.
  */
  ...
  int light_count_{0};
  int food_count_{0};
  /* Even number indicates exploratory behavior and odd number denotes fearful
  * behavior
  */
  int robot_light_behavior_flag_{1};
};
