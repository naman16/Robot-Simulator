...
struct WheelVelocity {
 public:
   ...
   * @brief Constructor
   *
   * @param[in] l The left wheel velocity.
   * @param[in] r The right wheel velocity.
   */
   ...
   * another Pose.
   *
   * @param[in] other The WheelVelocity object to copy from.
   *
   * @return The left-hand-side WheelVelocity object that is now identical
   * (in value) to `other`.
   */
